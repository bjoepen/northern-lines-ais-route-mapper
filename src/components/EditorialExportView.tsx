...
export const EditorialExportView:React.FC<Props>=({voyage,gapAdjustments,editorial,onEditorialChange})=><div className="w-full h-full overflow-y-auto bg-[#f4f1e9] p-6"><div className="max-w-7xl mx-auto flex gap-5 items-start"><div className="w-[300px] shrink-0 space-y-4"><EditorialContentEditor value={editorial} onChange={onEditorialChange}/><EditorialOutputControls voyage={voyage}/></div><div className="min-w-0 flex-1"><EditorialMapPreview voyage={voyage} gapAdjustments={gapAdjustments} editorial={editorial}/></div></div></div>;
